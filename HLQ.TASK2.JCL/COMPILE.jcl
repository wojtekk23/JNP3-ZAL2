...
//****************************************************************************
//COBOLCP  JOB REGION=0M,MSGCLASS=A,MSGLEVEL=(1,1),NOTIFY=&SYSUID
//***********************************************************
//CLEAN EXEC PGM=IEFBR14
//OLDDS  DD DSN=KC03H64.TASK2.OBJ,DISP=(MOD,DELETE),SPACE=(TRK,(30,30))
//***********************************************************
//COMPILE EXEC PGM=IGYCRCTL
//STEPLIB  DD   DSNAME=IGY620.SIGYCOMP,DISP=SHR
...
//SYSLIN   DD   DSNAME=&SYSUID..TASK2.OBJ,
//  DISP=(NEW,KEEP,KEEP),SPACE=(TRK,(30,30))
//SYSIN    DD   DSNAME=&SYSUID..TASK2(FXSORT),DISP=SHR 
